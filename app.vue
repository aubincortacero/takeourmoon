...
//attends que le model 3d soit visible 
  ...
  const content = document.querySelector('#wrapper').firstElementChild

  const lenis = new Lenis({
    smooth: true,
    lerp: 0.1, // plus bas = plus smooth mais plus de délai
  })

  // 🔑 Synchroniser ScrollTrigger avec Lenis
  lenis.on('scroll', ScrollTrigger.update)

    // Désactiver le défilement natif de ScrollTrigger
